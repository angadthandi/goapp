...
// Using lumberjack for its automatic log rotation and compression
func SetOutputFile(
	logFilePath string,
	logMaxSize int,
	logMaxBackups int,
	...
	logger.SetOutput(&lumberjack.Logger{
		...
		MaxBackups: logMaxBackups, // number of old compressed logs kept
		MaxAge:     logMaxAge,     // days
		Compress:   compressLogs,  // disabled by default
	})
}
